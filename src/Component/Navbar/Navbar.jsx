            ...
            <div className="navbar bg-base-100  w-11/12 md:w-10/12 mx-auto pl-0" >
                ...
                <div className="navbar-end">
                    ...
                    <div className="dropdown">
                        <div className='flex '>
                            {
                                user && <Link to='/dashboard' className="btn md:hidden uppercase rounded-2xl bg-[#34eb74] text-white hover:bg-[#97f7b9] hover:text-black "> <MdSpaceDashboard size={20} /></Link>
